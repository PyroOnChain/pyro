      ...
      <div className="shell" style={{ padding: '44px 40px 52px' }}>
        <div className="between" style={{ marginBottom: 34, gap: 60, flexWrap: 'wrap' }}>
          <div className="row" style={{ gap: 11 }}>
            ...
            <img src="/totem-mark.png" alt="Totem" style={{ height: 26, width: 26, border: '2px solid var(--ink)' }} />
            <span className="display" style={{ fontSize: 18, letterSpacing: '0.05em', color: 'var(--ink)' }}>Totem</span>
          </div>
        ...
        <p className="mono" style={{ fontSize: 11.5, lineHeight: 1.75, color: 'var(--dim)', margin: 0, maxWidth: 900 }}>
          ...
          and the UAE. Totem is unaudited software and you should treat it that way. Nothing here is investment advice.
        </p>
      </div>
    </footer>
  );
